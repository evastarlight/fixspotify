/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c59429e23bd28363b936bdb8bff4cb52)
// Runtime types generated with workerd@1.20260825.1 2026-08-01 
interface __BaseEnv_Env {
	TOKENS: KVNamespace;
	EMBED_LIMITER: RateLimit;
	ASSETS: Fetcher;
	MAIN_HOST: "fixspotify.com";
	OPEN_HOST: "open.fixspotify.com";
	LINK_HOST: "fixspotify.link";
	STATS_SAMPLE_RATE: "1";
	...
	STATS: DurableObjectNamespace<import("./worker/index").Stats>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Stats";
	}
